...
///
//We are given code in a modified programming language is given, where
//functions are represented by an opening and closing tag ("functionName" and "endfunctionName").
